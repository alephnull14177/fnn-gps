...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gps_translation.autotvin.dat"
	set constFileTvOut       "gps_translation.autotvout.dat"
	set constFileHdlTvIn     "gps_translation.autohdltvin.dat"
	set constFileHdlTvOut    "gps_translation.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

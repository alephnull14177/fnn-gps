...
$(ObjDir)/parser_tb.cpp_pre.cpp.tb.o : parser_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling parser_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/parser.cpp_pre.cpp.tb.o : parser.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling parser.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)

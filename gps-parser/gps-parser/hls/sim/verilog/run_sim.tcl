...
if {[file isfile gps_translation.autotvin.dat]} {
	file delete -force gps_translation.autotvin.dat
}

if {[file isfile gps_translation.autotvout.dat]} {
	file delete -force gps_translation.autotvout.dat
}
